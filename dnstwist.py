...
class Fuzzer():
	def __init__(self, domain, dictionary=[], tld_dictionary=[]):
		...
		self.glyphs = {
			...
			'8': ['3'],
			'9': ['6'],
		 'a': ['á','à','â','ǎ','ă','ã','ả','ȧ','ạ','ä','å','ḁ','ā','ą','ᶏ','ⱥ','ȁ','ấ','ầ','ẫ','ẩ','ậ','ắ','ằ','ẵ','ẳ','ặ','ǻ','ǡ','ǟ','ȁ','ȃ','ɑ', 'ạ','ə'],
   		 'b': ['d','lb','ḃ','ḅ','ḇ','ƀ','ɓ','ƃ','ᵬ','ᶀ','ʙ','Ｂ','ｂ','ƅ'],
    		 'c': ['c','e', 'ƈ','Ć','ć','Ĉ','ĉ','Č','č','Ċ','ċ','̄c̄','Ç','ç','Ḉ','ḉ','Ȼ','ȼ','Ƈ','ƈ','ɕ','ᴄ','Ｃ','ｃ'],
    		 'd': ['b','cl','dl','ď','ḋ','ḑ','ḍ','ḓ','ḏ','đ','Ð','ð','̦d̦','ɖ','ɗ','ᵭ','ᶁ','ᶑ','ȡ','ᴅ','ｄ'],
    		 'e': ['ɇ','é','è','ê','ḙ','ě','ĕ','ẽ','ḛ','ẻ','ė','ë','ē','ȩ','ę','ᶒ','ȅ','ế','ề','ễ','ể','ḝ','ḗ','ḕ','ȇ','ẹ','ệ','ⱸ','ᴇ','ｅ'],
    		 'f': ['Ḟ','ḟ','Ƒ','ƒ','ᵮ','ᶂ','ꜰ','Ｆ','ｆ'],
   		 'g': ['q''ǵ','ğ','ĝ','ǧ','ġ','ģ','ḡ','ǥ','ᶃ','ｇ','ɢ','ɡ'],
   		 'h': ['lh','ĥ','ȟ','ḧ','ḣ','ḩ','ḥ','ḫ','̱ẖ','ħ','ⱨ','ɦ','ｈ'],
    		 'i': ['ɩ','l','1','Í','í','Ì','ì','Ĭ','ĭ','Î','î','Ǐ','ǐ','Ï','ï','Ḯ','ḯ','Ĩ','ĩ','Į','į','Ī','ī','Ỉ','ỉ','Ȉ','ȉ','Ȋ','ȋ','Ị','ị','Ḭ','ḭ','Ɨ','ɨ','ᵻ','ᶖ','İ','ı','ɪ','Ｉ','ｉ'],
    		 'j': ['ǰ','Ĵ','ĵ','ɉ','̌ǰ','ȷ','ʝ','ɟ','ʄ','ᴊ','Ｊ','ｊ','I'],
    		 'k': ['lc','ik','lk','Ḱ','ḱ','Ǩ','ǩ','Ķ','ķ','Ḳ','ḳ','Ḵ','ḵ','Ƙ','ƙ','Ⱪ','ⱪ','ᶄ','ᶄ','Ꝁ','ꝁ','ᴋ','Ｋ','ｋ'],
    		 'l': ['i','i','1','Ĺ','ĺ','Ľ','ľ','Ļ','ļ','Ḷ','ḷ','Ḹ','ḹ','Ḽ','ḽ','Ḻ','ḻ','Ł','ł','Ŀ','ŀ','Ƚ','ƚ','Ⱡ','ⱡ','Ɫ','ɫ','ɬ','ᶅ','ɭ','ȴ','ʟ','Ｌ','ｌ'],
    		 'm': ['rr','rn','nn','n','Ḿ','ḿ','ṁ','Ṃ','ṃ','ᵯ','ᶆ','Ɱ','ɱ','ᴍ','Ｍ','ｍ'],
    		 'n': ['ꞑ','r','m','Ń','ń','Ǹ','ǹ','Ň','ň','Ñ','ñ','Ṅ','ṅ','Ņ','ņ','Ṇ','ṇ','Ṋ','ṋ','Ṉ','ṉ','̈n̈','Ɲ','ɲ','Ƞ','ƞ','ᵰ','ᶇ','ɳ','ȵ','ɴ','Ｎ','ｎ','Ŋ','ŋ'],
    		 'o': ['0','Ó','ó','Ò','ò','Ŏ','ŏ','Ô','ô','Ố','ố','Ồ','ồ','Ỗ','ỗ','Ổ','ổ','Ǒ','ǒ','Ö','ö','Ȫ','ȫ','Ő','ő','Õ','õ','Ṍ','ṍ','Ṏ','ṏ','Ȭ','ȭ','Ȯ','ȯ','Ȱ','ȱ','Ø','ø','Ǿ','ǿ','Ǫ','ǫ','Ǭ','ǭ','Ō','ō','Ṓ','ṓ','Ṑ','ṑ','Ỏ','ỏ','Ȍ','ȍ','Ȏ','ȏ','Ơ','ơ','Ớ','ớ','Ờ','ờ','Ỡ','ỡ','Ở','ở','Ợ','ợ','Ọ','ọ','Ộ','ộ','Ɵ','ɵ','ⱺ','ᴏ','Ｏ','ｏ'],
    		 'p': ['ƿ','Ṕ','ṕ','Ṗ','ṗ','Ᵽ','ᵽ','Ƥ','ƥ','̃p','̃ᵱ','ᶈ','ᴘ','Ｐ','ｐ','ȹ'],
    		 'q': ['g','Ɋ','ɋ','ʠ','Ｑ','ｑ','ȹ'],
   		 ...
   		 'w': ['vv',Ẃ','ẃ','Ẁ','ẁ','Ŵ','ŵ','Ẅ','ẅ','Ẇ','ẇ','Ẉ','ẉ','ẘ','ẘ','Ⱳ','ⱳ','ᴡ','Ｗ','ｗ'],
   		 'x': ['Ẍ','ẍ','Ẋ','ẋ','ᶍ','Ｘ','ｘ'],
    		 'y': ['ỿ',Ý','ý','Ỳ','ỳ','Ŷ','ŷ','ẙ','Ÿ','ÿ','Ỹ','ỹ','Ẏ','ẏ','Ȳ','ȳ','Ỷ','ỷ','Ỵ','ỵ','Ɏ','ɏ','Ƴ','ƴ','ʏ','Ｙ','ｙ'],
